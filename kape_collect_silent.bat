...
:: Version: 0.1
:: Date: 2025-05-03
:: Purpose: Surreptitious collection using !BasicCollection and !SANS_Triage targets from a live Windows system (silent mode).
:: GitHub: https://github.com/rsgrizz
:: ====================================================

:: Self-elevate silently if not admin
fltmc >nul 2>&1 || (
